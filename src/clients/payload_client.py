...
class PayloadCmsJournalEntry:
    ...
    richTextContent: Optional[Any] = None
    ...
    location: Optional[PayloadCmsLocation] = None
    weather: Optional[PayloadCmsWeather] = None
    timezone: Optional[str] = None
    deviceName: Optional[str] = None
    stepCount: Optional[int] = None
    source: Optional[PayloadCmsSource] = None
...
def _payload_doc_to_journal_entry(doc: Dict[str, Any]) -> JournalEntry:
    ...
    return JournalEntry(
        ...
        entry_at=parse_dt(doc.get("entryAt")),
