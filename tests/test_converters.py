...
SAMPLE_JOURNEY_RECORD = {
    ...
    "location": {
      "lat": 36.66111755371094,
      "lng": 137.22857666015625
    },
    "weather": {
      "id": 0,
      "degreeC": 16.3,
    ...
    "attachments": [
      "aKBma1YNyDgmP64y5QdE.jpg",
      "KZXkb6oLngAWSJNUmRYb.jpg"
    ],
    "tags": [],
    "encrypted": False,
    "version": 1,
...
def test_conversion_roundtrip():
    ...
    # 3. Assert: The final object should be identical to the original.
    # The dataclass __eq__ method provides a deep comparison.
    assert original_journey_entry == final_journey_entry
